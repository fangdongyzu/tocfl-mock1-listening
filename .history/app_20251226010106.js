          ...
          <div className="modal-content">
            ...
            <div className="modal-buttons" style={{ justifyContent: 'center', marginBottom: 20, paddingTop: 10 }}>
              <div className="result-actions">
                <button className="restart-btn" style={{ background: '#e67e22', marginBottom: '5px' }} onClick={() => window.location.reload()}>
                  Retake Test
                </button>
                <button className="home-btn" style={{ background: '#7f8c8d' }} onClick={() => window.location.href = "https://fangdongyzu.github.io/tocflmock/"}>
                  Home Page
                </button>
              </div>
